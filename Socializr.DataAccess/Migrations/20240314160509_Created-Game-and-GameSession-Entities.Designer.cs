...
namespace SocializR.DataAccess.Migrations
{
    ...
    [Migration("20240314160509_Created-Game-and-GameSession-Entities")]
    partial class CreatedGameandGameSessionEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Socializr.Models.Entities.GameSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("NumberOfCorrectEasyQuestions")
                        .HasColumnType("int");

                    b.Property<int>("NumberOfCorrectExtremeQuestions")
                        .HasColumnType("int");

                    b.Property<int>("NumberOfCorrectHardQuestions")
                        .HasColumnType("int");

                    b.Property<int>("NumberOfCorrectMediumQuestions")
                        .HasColumnType("int");

                    b.Property<int>("NumberOfIncorrectEasyQuestions")
                        .HasColumnType("int");

                    b.Property<int>("NumberOfIncorrectExtremeQuestions")
                        .HasColumnType("int");

                    b.Property<int>("NumberOfIncorrectHardQuestions")
                        .HasColumnType("int");

                    b.Property<int>("NumberOfIncorrectMediumQuestions")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SocializR.Models.Entities.User", b =>
                {
                    ...
                    b.OwnsOne("SocializR.Models.Entities.Game", "Game", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<int>("NumberOfHearts")
                                .HasColumnType("int");
