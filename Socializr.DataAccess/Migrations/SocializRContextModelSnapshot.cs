...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocializR.Entities.Album", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SocializR.Entities.City", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SocializR.Entities.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SocializR.Entities.County", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SocializR.Entities.FriendRequest", b =>
                {
                    ...
                    b.HasKey("RequesterUserId", "RequestedUserId");
            ...
            modelBuilder.Entity("SocializR.Entities.Friendship", b =>
                {
            ...
            modelBuilder.Entity("SocializR.Entities.Interest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SocializR.Entities.Like", b =>
                {
                    b.Property<Guid>("PostId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("PostId");
            ...
            modelBuilder.Entity("SocializR.Entities.Media", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SocializR.Entities.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SocializR.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SocializR.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SocializR.Entities.UserInterest", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("UserId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("SocializR.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("SocializR.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SocializR.Entities.Album", b =>
                {
                    b.HasOne("SocializR.Entities.User", "User")
                        .WithMany("Albums")
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("SocializR.Entities.City", b =>
                {
                    b.HasOne("SocializR.Entities.County", "County")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("SocializR.Entities.Comment", b =>
                {
                    b.HasOne("SocializR.Entities.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("SocializR.Entities.FriendRequest", b =>
                {
                    b.HasOne("SocializR.Entities.User", "RequestedUser")
                        .WithMany("FriendRequestsRequestedUser")
                        .HasForeignKey("RequestedUserId")
                        .IsRequired()
                        .HasConstraintName("FK_Friends_Users1");

                    b.HasOne("SocializR.Entities.User", "RequesterUser")
            ...
            modelBuilder.Entity("SocializR.Entities.Friendship", b =>
                {
                    b.HasOne("SocializR.Entities.User", "FirstUser")
                        .WithMany("FriendsFirstUser")
                        .HasForeignKey("FirstUserId")
                        .IsRequired()
                        .HasConstraintName("FK_Friends_Users2");

                    b.HasOne("SocializR.Entities.User", "SecondUser")
            ...
            modelBuilder.Entity("SocializR.Entities.Interest", b =>
                {
                    b.HasOne("SocializR.Entities.Interest", "Parent")
            ...
            modelBuilder.Entity("SocializR.Entities.Media", b =>
                {
                    b.HasOne("SocializR.Entities.Album", "Album")
                        .WithMany("Media")
            ...
            modelBuilder.Entity("SocializR.Entities.User", b =>
                {
                    b.HasOne("SocializR.Entities.City", "City")
                        .WithMany("Users")
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_Users_Cities");

                    b.HasOne("SocializR.Entities.Media", "ProfilePhoto")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("SocializR.Entities.UserInterest", b =>
                {
                    b.HasOne("SocializR.Entities.Interest", "Interest")
